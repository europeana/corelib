...
public interface Aggregation extends AbstractEdmEntity {
  ...
  /**
   * gets prov:wasGeneratedBy.
   *
   * @return the prov was generated by
   */
  String getWasGeneratedBy();

  /**
   * Sets prov:wasGeneratedBy.
   *
   * @param provWasGeneratedBy the prov was generated by
   */
  void setWasGeneratedBy(String provWasGeneratedBy);
