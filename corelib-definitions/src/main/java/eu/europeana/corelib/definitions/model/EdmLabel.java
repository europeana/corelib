...
public enum EdmLabel {
	...
	EDM_TYPE("edm_type",SolrType.FACET), 
	...
	EDM_DATA_PROVIDER("edm_dataProvider", SolrType.FACET), 
	...
	AGGR_DC_RIGHTS("aggr_dc_rights", SolrType.FACET),
	AGGR_EDM_RIGHTS("aggr_edm_rights", SolrType.FACET), 
	...
	DC_COVERAGE("dc_coverage", SolrType.FACET), 
	DC_CONTRIBUTOR("dc_contributor", SolrType.NOT_STORED), 
	DC_DESCRIPTION("dc_description", SolrType.NOT_STORED), 
	DC_CREATOR("dc_creator", SolrType.FACET), 
	DC_DATE("dc_date", SolrType.FACET), 
	...
	PRX_DC_RIGHTS("prx_dc_rights", SolrType.FACET), 
	PRX_EDM_RIGHTS("prx_edm_rights", SolrType.FACET),
	DC_SOURCE("dc_source", SolrType.NOT_STORED), 
	DC_SUBJECT("dc_subject", SolrType.NOT_STORED), 
	DC_TITLE("dc_title", SolrType.NOT_STORED), 
	DC_TYPE("dc_type", SolrType.FACET), 
	DCTERMS_ALTERNATIVE("dcterms_alternative",SolrType.FACET), 
	...
	DCTERMS_TEMPORAL("dcterms_temporal",SolrType.FACET), 
	...
	PREVIEW_NO_DISTRIBUTE("europeana_previewNoDistribute", SolrType.INDEXED),
	NULL("null",null)
	;
