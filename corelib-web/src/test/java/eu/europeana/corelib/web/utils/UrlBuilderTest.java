...
public class UrlBuilderTest {
	...
	public void testUrlCleaning() {
		String dirty = "http://www.europeana.eu//index?";
		String clean = "http://www.europeana.eu/index";
		...
		dirty = "www.europeana.eu//";
		clean = "https://www.europeana.eu";
		url = new UrlBuilder(dirty);
		assertEquals("Cleaning of ending slashes and missing protocol", clean, url.toString());

		dirty = "https://www.europeana.eu//index?var1=value1&&var2=value2&";
		clean = "https://www.europeana.eu/index?var1=value1&var2=value2";
		url = new UrlBuilder(dirty);
	...
	public void testProtocolSupport() {
		String dirty = "ftp://www.europeana.eu//index?var1=value1&&var2=value2&";
		String clean = "ftp://www.europeana.eu/index?var1=value1&var2=value2";
		UrlBuilder url = new UrlBuilder(dirty);
		assertEquals("Cleaning of ending or double &", clean, url.toString());

		String expected = "www.europeana.eu/user/";
		url = new UrlBuilder("http://www.europeana.eu/");
		url.addPath("user").disableProtocol();
		assertEquals("Disabling protocol", expected, url.toString());
	}

	@Test
	public void testAddPath() {
		String expected = "http://www.europeana.eu/user/";
	...
	public void testAddPage() {
		String expected = "http://www.europeana.eu/index.html";
		UrlBuilder url = new UrlBuilder("http://www.europeana.eu");
		...
		expected = "http://www.europeana.eu/record/09303/0B7E902E597DA16379C9AEC6EDC8C1E19CEBE9DC?start=1&query=money&startPage=1&rows=24";
		url = new UrlBuilder("http://www.europeana.eu/");
		url.addPath("record").addPath("09303");
		url.addPage("0B7E902E597DA16379C9AEC6EDC8C1E19CEBE9DC");
