...
/**
 * This interceptor used by Portal catches all request after processing the controller
 * and populates all default configuration values, which are used on every page.
 * 
...
public class ConfigInterceptor extends HandlerInterceptorAdapter {
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object o, ModelAndView modelAndView) throws Exception {
        ...
        if (modelAndView!=null && !modelAndView.getViewName().startsWith("redirect:")) {
            if (modelAndView.getModel().containsKey(PageData.PARAM_MODEL)) {
     ...
     * @throws WebConfigurationException Exception is thrown if the given value does not contain a value.
     */
