...
public enum ProblemType {
    ...
    SEARCH_QUERY_INVALID("400-A", "Invalid search query", ProblemResponseAction.LOG_WARN),
    SEARCH_CURSORMARK_INVALID("400-C","Invalid cursor value. Please make sure you encode the cursor value before sending it to the API.",
            ProblemResponseAction.LOG_WARN),
    SEARCH_START_AND_CURSOR("400-D", "Parameters 'start' and 'cursorMark' cannot be used together", ProblemResponseAction.LOG_WARN),
    SEARCH_QUERY_EMPTY("400-E", "Empty search query parameter", ProblemResponseAction.LOG_WARN),
    SEARCH_HITSELECTOR_INVALID("400-H", "Invalid search hit selector value", ProblemResponseAction.LOG_WARN),
    SEARCH_PAGE_LIMIT_REACHED("400-L",
    ...
    SEARCH_FACET_RANGE_INVALID("400-R", "Invalid search facet range value", ProblemResponseAction.LOG_WARN),
    SEARCH_THEME_UNKNOWN("400-T", "Theme does not exist", ProblemResponseAction.LOG_WARN),
    SEARCH_THEME_MULTIPLE("400-S", "Theme parameter accepts one value only", ProblemResponseAction.LOG_WARN),

    CANT_CONNECT_SOLR("503-A","Unable to connect to search engine.", ProblemResponseAction.MAIL),
