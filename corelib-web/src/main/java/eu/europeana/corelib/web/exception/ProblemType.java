...
public enum ProblemType {
	...
	NEO4J_502_BAD_DATA("Inconsistency in hierarchical data for record", ProblemResponseAction.LOG),
	NEO4J_503_CONNECTION("Could not connect to Neo4j service", ProblemResponseAction.LOG),
