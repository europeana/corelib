...
public class ProxyUpdater implements Updater<ProxyImpl> {
	...
	private boolean updateArray(String[] orig, String[] ret, String field) {
		if (orig != null) {
	...
	public void update(ProxyImpl retProxy, ProxyImpl proxy,
		...
		update = update(
				...
				|| update;
		update = update(proxy.getDcCoverage() != null ? proxy.getDcCoverage()
				: null,
				retProxy.getDcCoverage() != null ? retProxy.getDcCoverage()
						: null, "dcCoverage")
				|| update;
		update = update(proxy.getDcCreator() != null ? proxy.getDcCreator()
				: null,
				retProxy.getDcCreator() != null ? retProxy.getDcCreator()
						: null, "dcCreator")
				|| update;
		update = update(proxy.getDcDate() != null ? proxy.getDcDate() : null,
		...
		update = update(
				...
				|| update;
		update = update(proxy.getDcFormat() != null ? proxy.getDcFormat()
		...
		update = update(
				...
				retProxy.getDcIdentifier() != null ? retProxy.getDcIdentifier()
						: null, "dcIdentifier")
				|| update;
		update = update(proxy.getDcLanguage() != null ? proxy.getDcLanguage()
				: null,
				retProxy.getDcLanguage() != null ? retProxy.getDcLanguage()
						: null, "dcLanguage")
				|| update;
		update = update(proxy.getDcPublisher() != null ? proxy.getDcPublisher()
				: null,
				retProxy.getDcPublisher() != null ? retProxy.getDcPublisher()
						: null, "dcPublisher")
				|| update;
		update = update(proxy.getDcRelation() != null ? proxy.getDcRelation()
				: null,
				retProxy.getDcRelation() != null ? retProxy.getDcRelation()
						: null, "dcRelation")
				|| update;
		update = update(proxy.getDcRights() != null ? proxy.getDcRights()
				: null, retProxy.getDcRights() != null ? retProxy.getDcRights()
				: null, "dcRights")
				|| update;
		update = update(proxy.getDcSource() != null ? proxy.getDcSource()
				: null, retProxy.getDcSource() != null ? retProxy.getDcSource()
				: null, "dcSource")
				|| update;
		update = update(proxy.getDcSubject() != null ? proxy.getDcSubject()
				: null,
				retProxy.getDcSubject() != null ? retProxy.getDcSubject()
						: null, "dcSubject")
				|| update;
		update = update(proxy.getDcTitle() != null ? proxy.getDcTitle() : null,
				retProxy.getDcTitle() != null ? retProxy.getDcTitle() : null,
				"dcTitle")
				|| update;
		update = update(proxy.getDcType() != null ? proxy.getDcType() : null,
		...
		update = update(
				...
				|| update;
		update = update(proxy.getDctermsTOC() != null ? proxy.getDctermsTOC()
				: null,
		...
		update = update(proxy.getEdmRights() != null ? proxy.getEdmRights()
				: null,
				retProxy.getEdmRights() != null ? retProxy.getEdmRights()
						: null, "edmRights")
				|| update;
		update = update(proxy.getEdmHasMet() != null ? proxy.getEdmHasMet()
				: null,
				retProxy.getEdmHasMet() != null ? retProxy.getEdmHasMet()
						: null, "edmHasMet")
				|| update;
		update = update(proxy.getEdmHasType() != null ? proxy.getEdmHasType()
				: null,
		...
		update = updateArray(
				...
				|| update;
		update = updateArray(proxy.getProxyIn() != null ? proxy.getProxyIn()
