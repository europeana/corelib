...
public final class ProxyFieldInput {
	...
	public ProxyImpl createProxyMongoFields(ProxyImpl mongoProxy,
			ProxyType proxy, Neo4jServer neo4jServer)
		...
		ProxyImpl retProxy =  null; //(ProxyImpl) neo4jServer.find( proxy.getAbout(),new ProxyImpl());
		if (retProxy != null) {
			neo4jServer.save(mongoProxy);
		} else {
			neo4jServer.save(mongoProxy);
		}
	...
	public ProxyImpl addProxyForMongo(ProxyImpl proxy, Aggregation aggregation,
			Neo4jServer neo4jServer) throws InstantiationException,
	 ...
	 *            The proxy to alter
	 * @param aggregation
	 *            The EuropeanaAggregation to link the proxy to
	 * @param neo4jServer
	 *            The neo4jServer to use to save the proxy
	 * @return
	 * @throws InstantiationException
	 * @throws IllegalAccessException
	 */
	public ProxyImpl addEuropeanaProxyForMongo(ProxyImpl proxy,
			EuropeanaAggregationType aggregation, Neo4jServer neo4jServer)
			throws InstantiationException, IllegalAccessException {
		proxy.setProxyFor("/item"
				+ aggregation.getAggregatedCHO().getResource());
		proxy.setProxyIn(new String[] { SolrUtils.exists(String.class,
	 ...
	 * 
	 * @param aggregation
	 *            The EuropeanaAggregation linked to this proxy
	 * @param solrInputDocument
	 *            The solrdocument to append the fields to
	 * @return
	 * @throws InstantiationException
	 * @throws IllegalAccessException
	 */
	 ...
	 * 
	 * @param about
	 *            The about field value used to delete the proxy
	 * @param neo4jServer
	 *            The server used to delete the proxy
	 */
	public void deleteProxyFromMongo(String about, Neo4jServer neo4jServer) {
