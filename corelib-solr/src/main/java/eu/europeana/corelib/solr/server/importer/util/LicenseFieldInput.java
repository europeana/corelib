...
public class LicenseFieldInput {
	...
	public SolrInputDocument createLicenseSolrFields(
		...
		solrInputDocument.addField(EdmLabel.LIC_RDF_ABOUT.toString(),
				license.getAbout());
		solrInputDocument.addField(EdmLabel.LIC_CC_DEPRECATED_ON.toString(), license
				.getDeprecatedOn().getDate());
		solrInputDocument.addField(EdmLabel.LIC_ODRL_INHERITED_FROM.toString(),
