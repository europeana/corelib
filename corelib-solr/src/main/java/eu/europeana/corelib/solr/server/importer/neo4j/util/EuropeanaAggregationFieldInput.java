...
public final class EuropeanaAggregationFieldInput {
	 ...
	 * @param neo4jserver
	 *            The neo4jserver to use to save the EuropeanaAggregation
	...
	public EuropeanaAggregationImpl createAggregationMongoFields(
			...
			Neo4jServer neo4jserver, String previewUrl)
			throws InstantiationException, IllegalAccessException {
...
//			ops.set("edmPreview", preview);
//		}
		EuropeanaAggregationImpl retrievedAggregation = (EuropeanaAggregationImpl) neo4jserver.find(aggregation.getAbout(),new EuropeanaAggregationImpl());
