...
public final class AggregationFieldInput {
     ...
     *
     * @param aggregation A JiBX entity that represents an Aggregation
     ...
     *
     * @param aggregations The List of aggregations in a record
     * @param webResources The List of webresources to be appended to an aggregation
     * @param mongoServer The instance of the MongoDBServer the aggregation is going to be saved
     * @return The aggregation Object that was altered (???to be converted to ArrayList of aggregations???)
     * @throws InstantiationException
     * @throws IllegalAccessException
     */
     ...
     *
     * @param aggregations The list of aggregations to search on
     * @param webResource The webresource from which the aggregation is extracted
    ...
    /**
     * Create an Aggregation MongoDBEntity. The webresources are not inserted at this method. as the aggregation may be
     * created before the web resources are encountered in the EDM parsing or after.
     *
     * @param aggregation The JiBX Aggregation entity
     * @param mongoServer The mongoServer instance that Aggregation is going to be saved in
