...
public class EuropeanaIdRegistryMongoServerImpl implements MongoServer, EuropeanaIdRegistryMongoServer {
    ...
    private static final Logger LOG = LogManager.getLogger(EuropeanaIdRegistryMongoServerImpl.class.getName());
     ...
     * @param createIndexes if true it will try to create all indexes if necessary when creating the datastore
     */
    public EuropeanaIdRegistryMongoServerImpl(String host,
                                              int port,
                                              String databaseName,
                                              String username,
                                              String password,
                                              boolean createIndexes) {
        this.mongoClient  = new MongoProviderImpl(host,
                String.valueOf(port),
                databaseName,
                username,
                password).getMongo();
