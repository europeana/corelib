...
import eu.europeana.corelib.neo4j.server.Neo4jServerNew;
...
public class Neo4jServerImplNew implements Neo4jServerNew {

	private final static Logger LOG = Logger.getLogger(Neo4jServerImplNew.class
			.getCanonicalName());
	 ...
	 */
	public Neo4jServerImplNew(String serverPath, String index, String customPath) {
