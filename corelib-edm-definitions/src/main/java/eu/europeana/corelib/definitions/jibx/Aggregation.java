 ...
 * <pre>
 * &lt;xs:element xmlns:ns="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:ns1="http://purl.org/dc/elements/1.1/" xmlns:ns2="http://www.openarchives.org/ore/terms/" xmlns:ns3="http://www.europeana.eu/schemas/edm/" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="Aggregation">
 *   &lt;xs:complexType>
 *     &lt;xs:complexContent>
 *       &lt;xs:extension base="ns:AboutType">
 *         &lt;xs:sequence>
 *           &lt;xs:element ref="ns3:aggregatedCHO" minOccurs="1" maxOccurs="1"/>
 *           &lt;xs:element ref="ns3:dataProvider" minOccurs="0" maxOccurs="1"/>
 *           &lt;xs:element ref="ns3:hasView" minOccurs="0" maxOccurs="unbounded"/>
 *           &lt;xs:element ref="ns3:isShownAt" minOccurs="0" maxOccurs="1"/>
 *           &lt;xs:element ref="ns3:isShownBy" minOccurs="0" maxOccurs="1"/>
 *           &lt;xs:element ref="ns3:object" minOccurs="0" maxOccurs="1"/>
 *           &lt;xs:element ref="ns3:provider" minOccurs="1" maxOccurs="1"/>
 *           &lt;xs:element ref="ns1:rights" minOccurs="0" maxOccurs="unbounded"/>
 *           &lt;xs:element ref="ns3:rights" minOccurs="1" maxOccurs="1"/>
 *           &lt;xs:element ref="ns3:ugc" minOccurs="0" maxOccurs="1"/>
 *           &lt;xs:element ref="ns3:intermediateProvider" minOccurs="0" maxOccurs="unbounded"/>
 *         &lt;/xs:sequence>
 *       &lt;/xs:extension>
 *     &lt;/xs:complexContent>
 *   &lt;/xs:complexType>
