...
public enum LanguageCodes {
    BG("bg"), CA("ca"), CS("cs"), DA("da"), DE("de"), EL("el"), EN("en"), ES(
            "es"), ET("et"), EU("eu"), FI("fi"), FR("fr"), GA("ga"), GD("gd"), HE(
            "he"), HR("hr"), HU("hu"), IE("ie"), IS("is"), IT("it"), KA("ka"), LT(
            "lt"), LV("lv"), MK("mk"), MT("mt"), MUL("mul"), NL("nl"), NO("no"), PL(
            "pl"), PT("pt"), RO("ro"), RU("ru"), SK("sk"), SL("sl"), SR("sr"), SV(
            "sv"), TR("tr"), UK("uk"), YI("yi"), CY("cy");
