 ...
 * <pre>
 * &lt;xs:complexType xmlns:ns="http://www.europeana.eu/schemas/edm/" xmlns:ns1="http://www.w3.org/2002/07/owl#" xmlns:ns2="http://www.openarchives.org/ore/terms/" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="ProxyType">
 *   &lt;xs:complexContent>
 *     &lt;xs:extension base="ns:BaseProvidedCHOType">
 *       &lt;xs:sequence>
 *         &lt;xs:element ref="ns:europeanaProxy" minOccurs="0" maxOccurs="1"/>
 *         &lt;xs:element ref="ns:userTag" minOccurs="0" maxOccurs="unbounded"/>
 *         &lt;xs:element ref="ns:year" minOccurs="0" maxOccurs="unbounded"/>
 *         &lt;xs:element ref="ns2:proxyFor" minOccurs="0" maxOccurs="1"/>
 *         &lt;xs:element ref="ns2:proxyIn" minOccurs="0" maxOccurs="unbounded"/>
 *         &lt;xs:element ref="ns:type" minOccurs="0" maxOccurs="1"/>
 *         &lt;xs:element ref="ns1:sameAs" minOccurs="0" maxOccurs="unbounded"/>
 *       &lt;/xs:sequence>
 *     &lt;/xs:extension>
 *   &lt;/xs:complexContent>
 * &lt;/xs:complexType>
