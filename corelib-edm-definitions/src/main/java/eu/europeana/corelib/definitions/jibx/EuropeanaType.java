...
public class EuropeanaType extends AboutType
{
     ...
     * Schema fragment(s) for this class:
     * <pre>
     * &lt;xs:choice xmlns:ns="http://purl.org/dc/elements/1.1/" xmlns:ns1="http://purl.org/dc/terms/" xmlns:xs="http://www.w3.org/2001/XMLSchema" minOccurs="0" maxOccurs="unbounded">
     *   &lt;xs:element ref="ns:contributor"/>
     *   &lt;xs:element ref="ns:coverage"/>
     *   &lt;xs:element ref="ns:creator"/>
     *   &lt;xs:element ref="ns:date"/>
     *   &lt;xs:element ref="ns:description"/>
     *   &lt;xs:element ref="ns:format"/>
     *   &lt;xs:element ref="ns:identifier"/>
     *   &lt;xs:element ref="ns:language"/>
     *   &lt;xs:element ref="ns:publisher"/>
     *   &lt;xs:element ref="ns:relation"/>
     *   &lt;xs:element ref="ns:rights"/>
     *   &lt;xs:element ref="ns:source"/>
     *   &lt;xs:element ref="ns:subject"/>
     *   &lt;xs:element ref="ns:title"/>
     *   &lt;xs:element ref="ns:type"/>
     *   &lt;xs:element ref="ns1:alternative"/>
     *   &lt;xs:element ref="ns1:conformsTo"/>
     *   &lt;xs:element ref="ns1:created"/>
     *   &lt;xs:element ref="ns1:extent"/>
     *   &lt;xs:element ref="ns1:hasFormat"/>
     *   &lt;xs:element ref="ns1:hasPart"/>
     *   &lt;xs:element ref="ns1:hasVersion"/>
     *   &lt;xs:element ref="ns1:isFormatOf"/>
     *   &lt;xs:element ref="ns1:isPartOf"/>
     *   &lt;xs:element ref="ns1:isReferencedBy"/>
     *   &lt;xs:element ref="ns1:isReplacedBy"/>
     *   &lt;xs:element ref="ns1:isRequiredBy"/>
     *   &lt;xs:element ref="ns1:issued"/>
     *   &lt;xs:element ref="ns1:isVersionOf"/>
     *   &lt;xs:element ref="ns1:medium"/>
     *   &lt;xs:element ref="ns1:provenance"/>
     *   &lt;xs:element ref="ns1:references"/>
     *   &lt;xs:element ref="ns1:replaces"/>
     *   &lt;xs:element ref="ns1:requires"/>
     *   &lt;xs:element ref="ns1:spatial"/>
     *   &lt;xs:element ref="ns1:tableOfContents"/>
     *   &lt;xs:element ref="ns1:temporal"/>
     * &lt;/xs:choice>
     * </pre>
     */
