	...
	<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:edm="http://www.europeana.eu/schemas/edm/"
		...
		>
			...
			<xsl:element name="ore:Aggregation" >
				...
				<xsl:if test="//record/provider_aggregation_edm_dataProvider">
				...
				<xsl:if test="//record/provider_aggregation_edm_hasView">
				...
				<xsl:if test="//record/provider_aggregation_edm_isShownAt">
				...
				<xsl:if test="//record/provider_aggregation_edm_isShownBy">
				...
				<xsl:if test="//record/provider_aggregation_edm_object">
				...
				<xsl:if test="//record/provider_aggregation_edm_provider">
				...
				<xsl:if test="//record/provider_aggregation_dc_rights">
				...
				<xsl:if test="//record/provider_aggregation_edm_rights">
			...
			<xsl:element name="edm:WebResource">
				...
				<xsl:if test="//record/wr_dc_description">
				...
				<xsl:if test="//record/wr_dc_format">
				...
				<xsl:if test="//record/wr_dc_rights">
				<xsl:element name="dc:rights">
					<xsl:choose>
				...
				<xsl:if test="//record/wr_dc_source">
				...
				<xsl:if test="//record/wr_dcterms_conformsTo">
				...
				<xsl:if test="//record/wr_dcterms_created">
				...
				<xsl:if test="//record/wr_dcterms_extent">
				...
				<xsl:if test="//record/wr_dcterms_hasPart">
				...
				<xsl:if test="//record/wr_dcterms_isFormatOf">
				...
				<xsl:if test="//record/wr_dcterms_issued">
				...
				<xsl:if test="//record/wr_edm_isNextInSequence">
				...
				<xsl:if test="//record/wr_edm_rights">
					<xsl:element name="edm:rights">
					<xsl:choose>
			...
			<xsl:element name="edm:Agent" >
				...
				<xsl:if test="//record/ag_skos_note">
				<xsl:element name="skos:note">
					<xsl:value-of select = "ag_skos_note"/>
				</xsl:element>
				</xsl:if>
				<xsl:if test="//record/ag_dc_date">
				...
				<xsl:if test="//record/ag_dc_identifier">
				<xsl:element name="dc:identifier">
					<xsl:value-of select="ag_dc_identifier" />
				</xsl:element>
				</xsl:if>
				<xsl:if test="//record/ag_edm_hasMet">
				<xsl:element name="edm:hasMet">
					<xsl:value-of select = "ag_edm_hasMet"/>
				</xsl:element>
				</xsl:if>
				<xsl:if test="//record/ag_edm_isRelatedTo">
				...
				<xsl:if test="//record/ag_owl_sameAs">
				...
				<!-- TIMESPAN -->
				<xsl:if test="//record/edm_timespan">
			<xsl:element name="edm:TimeSpan">
				...
				<xsl:if test="//record/ts_skos_note">
				<xsl:element name="skos:note">
					<xsl:value-of select = "ts_skos_note"/>
				</xsl:element>
				</xsl:if>
				<xsl:if test="//record/ts_dcterms_hasPart">
				<xsl:element name="dcterms:hasPart">
					<xsl:choose>
				...
				<xsl:if test="//record/ts_dcterms_isPartOf">
			...
			<xsl:element name="edm:Place">
				...
				<xsl:if test="//record/pl_skos_note">
				<xsl:element name="skos:note">
					<xsl:value-of select = "pl_skos_note"/>
				</xsl:element>
				</xsl:if>
				<xsl:if test="//record/pl_dcterms_hasPart">
				<xsl:element name="dcterms:hasPart">
					<xsl:choose>
				...
				<xsl:if test="//record/pl_dcterms_isPartOf">
				<xsl:element name="dcterms:isPartOf">
							<xsl:attribute name="rdf:resource">
				...
				<xsl:if test="//record/pl_owl_sameAs">
				<xsl:element name="owl:sameAs">
					<xsl:attribute name="rdf:resource">
			...
			<xsl:element name="skos:Concept">
				...
				<xsl:if test="//record/cc_skos_related">
				...
				<xsl:if test="//record/cc_skos_broadMatch">
				...
				<xsl:if test="//record/cc_skos_narrowMatch">
				...
				<xsl:if test="//record/cc_skos_relatedMatch">
				...
				<xsl:if test="//record/cc_skos_exactMatch">
				...
				<xsl:if test="//record/cc_skos_closeMatch">
				...
				<xsl:if test="//record/cc_skos_notation">
			...
			<xsl:if test="//record/europeana_edm_aggregation">
			<xsl:element name="edm:EuropeanaAggregation">
				<xsl:attribute name="rdf:about">
					<xsl:value-of select="europeana_edm_aggregation" />
				</xsl:attribute>
				<xsl:if test="//record/europeana_aggregation_dc_creator">
				...
				<xsl:if test="//record/europeana_aggregation_ore_aggregatedCHO">
				<xsl:element name="edm:aggregatedCHO">
					<xsl:attribute name="rdf:resource">
				...
				<xsl:if test="//record/europeana_aggregation_edm_country">
				...
				<xsl:if test="//record/europeana_aggregation_edm_hasView">
				<xsl:element name="edm:hasView">
					<xsl:attribute name="rdf:resource">
				...
				<xsl:if test="//record/europeana_aggregation_edm_isShownBy">
				<xsl:element name="edm:isShownBy">
					<xsl:attribute name="rdf:resource">
				...
				<xsl:if test="//record/europeana_aggregation_edm_landingPage">
				...
				<xsl:if test="//record/europeana_aggregation_edm_language">
				<xsl:element name="edm:language">
					<xsl:value-of select="europeana_aggregation_edm_language" />
				</xsl:element>
				</xsl:if>
				<xsl:if test="//record/europeana_aggregation_edm_rights">
				<xsl:element name="edm:rights">
					<xsl:choose>
						<xsl:when
				...
				<xsl:if test="//record/europeana_aggregation_ore_aggregates">
			...
			<!-- PROXY -->
			<xsl:if test="//record/proxy_ore_proxy">
			<xsl:element name="edm:Proxy">
				<xsl:attribute name="rdf:about">
					<xsl:value-of select="proxy_ore_proxy"/>
				</xsl:attribute>
				<xsl:if test="//record/proxy_dc_contributor">
				...
				<xsl:if test="//record/proxy_dc_creator">
				<xsl:element name="dc:creator">
					<xsl:choose>
				...
				<xsl:if test="//record/proxy_dc_coverage">
				...
				<xsl:if test="//record/proxy_dc_date">
				<xsl:element name="dc:date">
					<xsl:choose>
				...
				<xsl:if test="//record/proxy_dc_description">
				<xsl:element name="dc:description">
					<xsl:choose>
				...
				<xsl:if test="//record/proxy_dc_format">
				<xsl:element name="dc:format">
					<xsl:choose>
				...
				<xsl:if test="//record/proxy_dc_language">
				<xsl:element name="dc:language">
					<xsl:value-of select="proxy_dc_language" />
				</xsl:element>
				</xsl:if>
				<xsl:if test="//record/proxy_dc_publisher">
				...
				<xsl:if test="//record/proxy_dc_subject">
				...
				<xsl:if test="//record/proxy_dc_title">
				<xsl:element name="dc:title">
					<xsl:value-of select="proxy_dc_title" />
				</xsl:element>
				</xsl:if>
				<xsl:if test="//record/proxy_dc_type">
				...
				<xsl:if test="//record/proxy_dc_identifier">
				<xsl:element name="dc:identifier">
					<xsl:value-of select="proxy_dc_identifier" />
				</xsl:element>
				</xsl:if>
				<xsl:if test="//record/proxy_dc_relation">
				...
				<xsl:if test="//record/proxy_dc_source">
				<xsl:element name="dc:source">
					<xsl:choose>
				...
				<xsl:if test="//record/proxy_dc_rights">
				<xsl:element name="dc:rights">
					<xsl:choose>
				...
				<xsl:if test="//record/proxy_dcterms_alternative">
				<xsl:element name="dcterms:alternative">
					<xsl:value-of select="proxy_dcterms_alternative"/>
				</xsl:element>
				</xsl:if>
				<xsl:if test="//record/proxy_dcterms_conformsTo">
				<xsl:element name="dcterms:conformsTo">
					<xsl:choose>
				...
				<xsl:if test="//record/proxy_dcterms_created">
				<xsl:element name="dcterms:created">
					<xsl:choose>
				...
				<xsl:if test="//record/proxy_dcterms_extent">
				<xsl:element name="dcterms:extent">
					<xsl:choose>
				...
				<xsl:if test="//record/proxy_dcterms_hasFormat">
				...
				<xsl:if test="//record/proxy_dcterms_isPartOf">
				<xsl:element name="dcterms:isPartOf">
					<xsl:choose>
				...
				<xsl:if test="//record/proxy_dcterms_isReferencedBy">
				...
				<xsl:if test="//record/proxy_dcterms_isRequiredby">
				...
				<xsl:if test="//record/proxy_dcterms_isReplacedBy">
				...
				<xsl:if test="//record/proxy_dcterms_isVersionOf">
				...
				<xsl:if test="//record/proxy_dcterms_hasVersion">
				...
				<xsl:if test="//record/proxy_dcterms_issued">
				<xsl:element name="dcterms:issued">
					<xsl:choose>
				...
				<xsl:if test="//record/proxy_dcterms_medium">
				...
				<xsl:if test="//record/proxy_dcterms_provenance">
				...
				<xsl:if test="//record/proxy_dcterms_references">
				...
				<xsl:if test="//record/proxy_dcterms_replaces">
				...
				<xsl:if test="//record/proxy_dcterms_requires">
				...
				<xsl:if test="//record/proxy_dcterms_spatial">
				...
				<xsl:if test="//record/proxy_dcterms_tableOfContents">
				...
				<xsl:if test="//record/proxy_dcterms_temporal">
				...
				<xsl:if test="//record/proxy_edm_currentLocation">
				...
				<xsl:if test="//record/proxy_edm_hasMet">
				<xsl:element name="edm:hasMet">
					<xsl:value-of select="proxy_edm_hasMet" />
				</xsl:element>
				</xsl:if>
				<xsl:if test="//record/proxy_edm_hasType">
				...
				<xsl:if test="//record/proxy_edm_incorporates">
				...
				<xsl:if test="//record/proxy_edm_isDerivativeOf">
				...
				<xsl:if test="//record/proxy_edm_isNextInSequence">
				<xsl:element name="edm:isNextInSequence">
					<xsl:attribute name="rdf:resource">
				...
				<xsl:if test="//record/proxy_edm_isRelatedTo">
				<xsl:element name="edm:isRelatedTo">
					<xsl:choose>
				...
				<xsl:if test="//record/proxy_edm_isRepresentationOf">
				...
				<xsl:if test="//record/proxy_edm_isSimilarTo">
				...
				<xsl:if test="//record/proxy_edm_isSuccessorOf">
				...
				<xsl:if test="//record/proxy_edm_realizes">
				...
				<xsl:if test="//record/proxy_ore_proxyIn">
				...
				<xsl:if test="//record/proxy_owl_sameAs">
				<xsl:element name="owl:sameAs">
					<xsl:attribute name="rdf:resource">
