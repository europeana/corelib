...
/**
 * This class represents the data structure used for schema.org serialization of EDM Agents representing groups of persons (e.g. music bands, music orchestra, etc.)
 */
