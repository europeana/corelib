...
public interface SearchService {
     ...
     *
     * @param europeanaObjectId - The unique europeana id * @param similarItems - Whether to
     ...
     *
     * @param query    The search term to find suggestions for
    ...
    /**
     * Get the nodes preceding siblings
     *
     * @param nodeId The ID of the record
