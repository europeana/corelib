...
@Configuration
public class SearchServerBeanConfig {
    private static final Logger LOG = LogManager.getLogger(SearchServerBeanConfig.class);
    ...
    public SearchServerBeanConfig(@Autowired SolrConfigLoader configLoader) {
